  ...
  return (
    <div className="p-4 border rounded-lg shadow-lg max-w-md mx-auto mt-4">
      ...
      <Paragraph className="mb-4 text-gray-600">
        You have chosen to skip the categorisation of this item due to
        identification issues. Please confirm the following actions:
      </Paragraph>
      <Text>1. Place the item back in the box.</Text> <br></br>
      <Text>2. Return the box to its original location.</Text>
      <br></br>
