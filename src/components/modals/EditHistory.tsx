...
export const SubmitBtn:React.FC<React.PropsWithChildren<SubmitBtnProps>> = ({form, children}) => {
  ...
  return (
    <Button htmlType={"submit"} key={"Update"} type={"primary"} className={"w-full"}>
      {children}
    </Button>
  )
}

export const EditHistory = ({ record, handleOk, handleSubmit,handleDelete, isModalOpen, handleCancel, isScannedBy }: EditHistoryProps) => {
